...
public class AufgabenMixer implements IAufgabenGenerator{
    ...
    public String getVariant() {
        switch (state) {
            case 0:
                return afgAdd.getVariant();
            case 1:
                return afgMin.getVariant();
            case 2:
                return afgMul.getVariant();
            case 3:
                return afgDiv.getVariant();
        }
        return afgAdd.getVariant();
    }
